...
export default function Authenticated({ auth, header, children }) {
    ...
    return (
        <div className="min-h-screen bg-[#f0f0f0] font-sans">
            <Navbar auth={auth} quinielasHeader={quinielasHeader} quinielaActivaId={quinielaActivaId} />
            ...
            {/* Mobile dropdown */}
            <div className={(showingNavigationDropdown ? 'fixed top-0 left-0 right-0 bottom-0 z-50 bg-white overflow-y-auto pt-16' : 'hidden') + ' sm:hidden'}>
